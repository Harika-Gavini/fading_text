...
class _FadingTextScreenState extends State<FadingTextScreen>
  ...
  String _imageAsset =
      '/Users/harikagavini/Documents/gsu-course-work/mad/fading_text/assets/flutter.png'; // Update image path accordingly
  ...
  void changeText() {
    setState(() {
      if (_text == 'Welcome to Flutter Animations!') {
        ...
        _imageAsset =
            '/Users/harikagavini/Documents/gsu-course-work/mad/fading_text/assets/flutter-master.png'; // Update image path accordingly
      } else {
        _text = 'Welcome to Flutter Animations!';
        _imageAsset =
            '/Users/harikagavini/Documents/gsu-course-work/mad/fading_text/assets/flutter.png'; // Update back to initial image path
      }
    });
  }
